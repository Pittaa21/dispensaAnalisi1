...
\section{Limiti di funzioni}
    ...
    \end{align*}
        \newpage\begin{center}
        \LARGE\underline{Tabella Derivate Semplici}\\\vspace{10pt}\large
        {\rowcolors{1}{gray!10}{white!100}
        \begin{tabular}{| c | c |}
            \hline
    ...
    \newpage\begin{center}
        \LARGE\underline{Sviluppi di McLaurin}\\\vspace{10pt}\large
        {\rowcolors{1}{gray!10}{white!100}
        \begin{tabular}{| c | c | c |}
            \hline
    ...
    \end{defi}\vspace{20pt}
    \begin{center}
        \LARGE\underline{Integrali indefiniti noti}\\\vspace{10pt}\large
        {\rowcolors{1}{gray!10}{white!100}
        \begin{tabular}{| c | c |}
            \hline
