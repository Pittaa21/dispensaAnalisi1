...
\section{Limiti di funzioni}
    \begin{defi}{Definizione di intorno e limite}{}
        ...
        Dato $\varnothing\ne A\subseteq\mathbb{R},\ x_0\in\mathbb{R}\ \cup\ \{\pm\infty\}$ punto di accumulazione per $A,\ f:A\rightarrow\mathbb{R}$. Se esiste il limite $f$ per $x\rightarrow x_0$ allora è unico. E si indica con:
    ...
    \end{align*}
    Devo verificare che $\forall\epsilon>0\quad\exists\ \delta $ tale che se $\underbrace{|x-2|<\delta\ ,\ x\in\mathbb{R}\smallsetminus\{2\},\ x\ne2}_{0<|x-2|<\delta}$ allora 
\end{document}